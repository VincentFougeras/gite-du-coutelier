...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-118387568-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-118387568-1');
    </script>
    ...
    <title>Le Gîte du Coutelier @yield('title')</title>
